...
export const TechStack: React.FC<TechStackProps> = ({ img, imgName }) => {
    const [dayModeAtomValue] = useAtom(dayModeAtom);
      ...
      return (
        <>
            <div className={`${dayModeAtomValue ? 'bg-[#021709]' : 'bg-[#f7f7f2] border-2 border-[#7511F7]'} rounded-md p-6 flex justify-center items-center text-center gap-2 max-sm:pl-10 max-sm:pr-10`}>
