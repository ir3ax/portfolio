                ...
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        <div className="flex flex-shrink-0 items-center">
                            <img className="h-8 w-auto max-sm:ml-12" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=500" alt="Your Company" />
                        </div>
                    ...
                    {
                        dayModeAtomValue ?
                        <button className='max-sm:m-0 max-sm:mr-2 max-md:mr-2 max-md:m-0 ml-12' onClick={() => setDayModeAtomValue(!dayModeAtomValue)} aria-label="Turn On Light Mood">
                        ...
                        :
                        <button className='max-sm:m-0 max-sm:mr-2 max-md:mr-2 max-md:m-0 ml-12' onClick={() => setDayModeAtomValue(!dayModeAtomValue)} aria-label="Turn On Dark Mood">
